...
The current checked-in evidence is bound to Phase I main fingerprint `f3f65840e53777056fed4fc770853a522da85c46626f5bc910853515c266cc1a`. Every primary scan was `VALID` and untruncated. Compact documents bind the primary scans, PostgreSQL CRUD scans, cleanup ledger, Level 7 role verification and Codex cycle artifacts by SHA-256. The first candidate-head run [`30193615824`](https://github.com/datzle123/RealDone/actions/runs/30193615824) correctly rejected the previous fingerprint's external artifacts; after the real cases were rerun, PR run [`30195613599`](https://github.com/datzle123/RealDone/actions/runs/30195613599) passed 15/15. Hosted main run [`30195945498`](https://github.com/datzle123/RealDone/actions/runs/30195945498) repeated the Linux/macOS/Windows, Node 20/22, browser, database and package gates, passed all 15 normative gates, and signed both aggregate JSON artifacts. `gh attestation verify` matched their SHA-256 subjects. Released `v1.3.3` and its independent signed run [`30189340006`](https://github.com/datzle123/RealDone/actions/runs/30189340006) remain the historical published-package qualification.
...
Machine-readable main inputs are in `release/external-cases.json` and `release/evidence/`; hosted run [`30195945498`](https://github.com/datzle123/RealDone/actions/runs/30195945498) signed the Phase I aggregate after all 15 gates passed. For the released package, hosted run [`30189340006`](https://github.com/datzle123/RealDone/actions/runs/30189340006) independently passed and signed all 15 gates for `v1.3.3`. The earlier `v1.3.2` package path remains qualified by hosted run [`29977292441`](https://github.com/datzle123/RealDone/actions/runs/29977292441).
