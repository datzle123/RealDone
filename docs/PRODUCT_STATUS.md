...
| §12–13 Evidence and snapshots | PARTIAL | URL, redacted semantic DOM/control hashes, cookie hashes, local/session storage, bounded IndexedDB metadata, request/response, WebSocket frames, console/page error, downloads, screenshots, trace/video and timeline | automatic upload evidence plus unified provider/database linkage inside scan snapshots |
...
| §18 Detector system | PARTIAL | RD001–RD008, RD101–RD105, RD201–RD205, RD301–RD305 and RD1001–RD1005 (28 of 58 catalogued detectors) | remaining mock, auth, authorization, file, provider, and regression detectors |
...
| §25 Safety | PARTIAL | local/staging host policy, destructive/external opt-ins, redaction, cleanup ledger, cross-origin block and complex-action recording boundary | full external provider/database mutation classification and cleanup coverage |
