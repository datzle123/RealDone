...
The candidate implementation is isolated on `codex/phase-j-secret-safe-traces`. It is not complete until the gate above passes and the hosted branch run confirms the cross-platform/package paths.
